...
# Paths
df_listings = pd.read_csv(r"\AirbnbData\CleanData\df_listings_detailed_limpio.csv")
df_neighbourhoods = pd.read_csv(r"\AirbnbData\neighbourhoods.csv")
df_modelo = pd.read_csv(r"\AirbnbData\CleanData\df_modelo_limpio.csv")
modelo = joblib.load(r"\Modelos\modelo_RF_baseline.pkl")
listings = pd.read_csv(r"\AirbnbData\CleanData\df_listings_detailed_limpio.csv")
modelo_rev = joblib.load(r"\Modelos\modelo_RF_reviews.pkl")
